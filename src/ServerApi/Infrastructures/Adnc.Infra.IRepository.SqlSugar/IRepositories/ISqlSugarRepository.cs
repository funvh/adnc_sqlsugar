...
/// <summary>
/// SqlSugar 默认的、全功能的仓储接口
/// 适合传统三层模式开发，实体必须继承 SqlSugarEntity
/// </summary>
/// <typeparam name="TEntity"></typeparam>
public interface ISqlSugarRepository<TEntity> : ISqlSugarBaseRepository<TEntity>
    where TEntity : SqlSugarEntity, new()
{
    ...
    /// 执行原生Sql写操作
    /// </summary>
    Task<int> ExecuteSqlWriteAsync(string sql, object param, CancellationToken cancellationToken = default);
    ...
    /// <summary>
    /// 返回NavISugarQueryable{TEntity}
    /// </summary>
    /// <returns></returns>
    NavISugarQueryable<TEntity> AsNavQueryable();
    ...
    /// <returns></returns>
    Task<TEntity> FirstAsync(Expression<Func<TEntity, bool>> queryExpression, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken"><see cref="CancellationToken"/></param>
    /// <returns></returns>
    Task<TEntity?> GetAsync(Expression<Func<TEntity, bool>> whereExpression, Expression<Func<TEntity, dynamic>>? navigationPropertyPath = null, Expression<Func<TEntity, object>>? orderByExpression = null, bool ascending = false, bool writeDb = false, bool noTracking = true, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken"><see cref="CancellationToken"/></param>
    /// <returns></returns>
    Task<bool> UpdateAsync(TEntity entity, Expression<Func<TEntity, object>>[] updatingExpressions, CancellationToken cancellationToken = default);

    /// <summary>
    /// 返回IUpdateable{TEntity}
    /// </summary>
    /// <returns></returns>
    ...
    /// </summary>
    /// <returns></returns>
    IUpdateable<TEntity> AsUpdateable(dynamic updateDynamicObject);

    /// <summary>
    /// 返回IUpdateable{TEntity}
    /// </summary>
    /// <returns></returns>
    UpdateNavTaskInit<TEntity, TEntity> AsNavUpdateable(dynamic updateDynamicObject);
    ...
    /// <param name="cancellationToken"><see cref="CancellationToken"/></param>
    /// <returns></returns>
    Task<int> UpdateAsync(Expression<Func<TEntity, bool>> whereExpression, Expression<Func<TEntity, TEntity>> updatingExpression, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    /// <param name="keyValue">Id</param>
    /// <param name="isSoftDelte">是否软删除</param>
    /// <param name="cancellationToken"><see cref="CancellationToken"/></param>
    /// <returns></returns>
    Task<bool> DeleteAsync(long keyValue, bool isSoftDelte = true, CancellationToken cancellationToken = default);
