...
{
    /// <summary>
    /// SqlSugar简单的、基础的，初级的仓储接口
    /// 适合DDD开发模式,实体必须继承AggregateRoot
    /// </summary>
    /// <typeparam name="TEntity"></typeparam>
    public class SqlSugarBasicRepository<TEntity> : AbstractSqlSugarBaseRepository<ISqlSugarClient, TEntity>, ISqlSugarBasicRepository<TEntity>
            where TEntity : Entity, ISqlSugarEntity<long>, new()
    {
        public SqlSugarBasicRepository(ISqlSugarClient dbContext, IServiceProvider serviceProvider)
