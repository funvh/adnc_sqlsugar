...
{
    public static class AbstractDependencyRegistrarExtension
    {
        /// <summary>
        /// default rest policies
        /// </summary>
        /// <returns></returns>
        public static List<IAsyncPolicy<HttpResponseMessage>> GenerateDefaultRefitPolicies(
            this AbstractDependencyRegistrar _)
        {
            //隔离策略
        ...
        /// <returns></returns>
        public static List<IAsyncPolicy<HttpResponseMessage>> GenerateDefaultGrpcPolicies(this AbstractDependencyRegistrar registrar) => 
        ...
        public static bool IsDevelopment(this AbstractDependencyRegistrar _) => ASPNETCORE_ENVIRONMENT.EqualsIgnoreCase("Development");

        public static string GetEnvShortName(this AbstractDependencyRegistrar _)
        {
        ...
        public static bool IsEnableSkyApm(this AbstractDependencyRegistrar _)
        {
